...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full min-h-screen max-w-2xl px-6 lg:max-w-7xl flex flex-col justify-between">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3 flex-none">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img src="/cup.png" class="w-16 h-16">
                    </div>
                    @if (Route::has('login'))
                ...
                <main class="mt-6 h-100 grow">
                    <div class="mt-6 h-100 flex flex-col justify-between max-w-2xl mx-auto">
                        <h1 class="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
                            Coffee App
                        </h1>
                        <p class="mt-5 text-lg text-black dark:text-white">
                            This is a simple coffee app made to practice with the Laravel framework.
                            To try it out, you need to either <a href="{{ route('login') }}"
                                class="text-blue-500 hover:underline">login</a> or <a href="{{ route('register') }}"
                                class="text-blue-500 hover:underline">register</a>.
                        </p>
                    </div>
                </main>

                <footer class="py-16 text-center text-sm text-black dark:text-white/70 flex-none">
